...
// Prometheus brand color (from the company logo) — used as the default
// sidebar/logo tint across every theme, independent of each theme's own
// accent (`red`), so the brand identity stays consistent no matter which
// color theme a user picks.
const BRAND_COLOR = '#5B4CDB';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Prometheus Logo',    group: 'Sidebar' },
