...
from src.model_context import is_allowed_cloud_provider as _is_allowed_cloud_provider, ALLOWED_CLOUD_PROVIDER_MESSAGE as _BLOCKED_PROVIDER_MESSAGE
        ...
        if 300 <= r.status_code < 400:
            ...
            if loc.startswith("/login") or "/login" in loc:
                return {
                    ...
                    "error": "That is Prometheus, not a model server. Use the Ollama URL, usually http://host.docker.internal:11434/v1 in Docker.",
                }
...
def setup_model_routes(model_discovery):
    ...
    def create_model_endpoint(
        ...
        if not _is_allowed_cloud_provider(base_url):
            raise HTTPException(403, _BLOCKED_PROVIDER_MESSAGE)
        ...
        try:
            ...
            if body:
                ...
                if "base_url" in body and isinstance(body["base_url"], str):
                    ...
                    if _new_base:
                        if not _is_allowed_cloud_provider(_new_base):
                            raise HTTPException(403, _BLOCKED_PROVIDER_MESSAGE)
